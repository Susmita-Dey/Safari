...
function Player(bgColor, posTop, posLeft) {
    ...
    const move = (newStepsToMove, idOfPlayer) => {
        ...
        if (
            ...
            stateKey = Object.keys(stateData)[index];
            bgImg = stateData[stateKey].photo;
            ques1 = stateData[stateKey].questions.ques1.text;
            ques1Options = stateData[stateKey].questions.ques1.options;
            que1Correct = stateData[stateKey].questions.ques1.correct;

            ques2 = stateData[stateKey].questions.ques2.text;
            ques2Options = stateData[stateKey].questions.ques2.options;
            que2Correct = stateData[stateKey].questions.ques2.correct;

            ques3 = stateData[stateKey].questions.ques3.text;
            ques3Options = stateData[stateKey].questions.ques3.options;
            que3Correct = stateData[stateKey].questions.ques3.correct;
            setTimeout(() => {
                quizObj.popUpQuiz(
                    bgImg,
                    ques1,
    ...
    function Quiz() {
        const popUpQuiz = (
            ...
            quesOneOption2,
            quesOneOption3,
            quesOneOptionCorrect,
            quesTwo,
            quesTwoOption1,
            quesTwoOption2,
            quesTwoOption3,
            quesTwoOptionCorrect,
            quesThree,
            quesThreeOption1,
            quesThreeOption2,
            quesThreeOption3,
            quesThreeOptionCorrect
        ) => {
            // getting those elements of the quiz form which are going to be updated
            const bgSection = document.querySelector("#bg-section");
            bgSection.classList.add(`bg-[url("${bgImg}")]`);

            const questionOne = document.querySelector("#question-one");
            const questionOneOptions1 = document.querySelector(
                "#question-one-options1"
            );
            const questionOneOptions2 = document.querySelector(
                "#question-one-options2"
            );
            const questionOneOptions3 = document.querySelector(
                "#question-one-options3"
            );

            const questionTwo = document.querySelector("#question-two");
            const questionTwoOptions1 = document.querySelector(
                "#question-two-options1"
            );
            const questionTwoOptions2 = document.querySelector(
                "#question-two-options2"
            );
            const questionTwoOptions3 = document.querySelector(
                "#question-two-options3"
            );

            const questionThree = document.querySelector("#question-three");
            const questionThreeOptions1 = document.querySelector(
                "#question-three-options1"
            );
            const questionThreeOptions2 = document.querySelector(
                "#question-three-options2"
            );
            const questionThreeOptions3 = document.querySelector(
                "#question-three-options3"
            );

            // Updating the the data of elements which is just query aboved
            questionOne.textContent = quesOne;

            questionOneOptions1.querySelector("input").value = quesOneOption1;
            questionOneOptions1.querySelector("label").textContent =
                quesOneOption1;

            questionOneOptions2.querySelector("input").value = quesOneOption2;
            questionOneOptions2.querySelector("label").textContent =
                quesOneOption2;

            questionOneOptions3.querySelector("input").value = quesOneOption3;
            questionOneOptions3.querySelector("label").textContent =
                quesOneOption3;

            questionTwo.textContent = quesTwo;
            questionTwoOptions1.querySelector("input").value = quesTwoOption1;
            questionTwoOptions1.querySelector("label").textContent =
                quesTwoOption1;

            questionTwoOptions2.querySelector("input").value = quesTwoOption2;
            questionTwoOptions2.querySelector("label").textContent =
                quesTwoOption2;

            questionTwoOptions3.querySelector("input").value = quesTwoOption3;
            questionTwoOptions3.querySelector("label").textContent =
                quesTwoOption3;

            questionThree.textContent = quesThree;

            questionThreeOptions1.querySelector("input").value =
                quesThreeOption1;
            questionThreeOptions1.querySelector("label").textContent =
                quesThreeOption1;

            questionThreeOptions2.querySelector("input").value =
                quesThreeOption2;
            questionThreeOptions2.querySelector("label").textContent =
                quesThreeOption2;

            questionThreeOptions3.querySelector("input").value =
                quesThreeOption3;
            questionThreeOptions3.querySelector("label").textContent =
                quesThreeOption3;

            // Adding event listenor on submit button
            document
        ...
        const submitQuiz = (
            ...
            inputsOne.push(questionOneOptions1.querySelector("input"));
            inputsOne.push(questionOneOptions2.querySelector("input"));
            inputsOne.push(questionOneOptions3.querySelector("input"));
            ...
            inputsTwo.push(questionTwoOptions1.querySelector("input"));
            inputsTwo.push(questionTwoOptions2.querySelector("input"));
            inputsTwo.push(questionTwoOptions3.querySelector("input"));
            ...
            inputsThree.push(questionThreeOptions1.querySelector("input"));
            inputsThree.push(questionThreeOptions2.querySelector("input"));
            inputsThree.push(questionThreeOptions3.querySelector("input"));
        ...
        const checkScore = (
            ...
            for (let i = 0; i < listOne.length; i++) {
                if (listOne[i].checked === true) {
                    if (listOne[i].value === quesOneOptionCorrect) {
                        score++;
                    }
                }
                listOne[i].checked = false;
            }

            for (let i = 0; i < listTwo.length; i++) {
                if (listTwo[i].checked === true) {
                    if (listTwo[i].value === quesTwoOptionCorrect) {
                        score++;
                    }
                }
                listTwo[i].checked = false;
            }

            for (let i = 0; i < listThree.length; i++) {
                if (listThree[i].checked === true) {
                    if (listThree[i].value === quesThreeOptionCorrect) {
                        score++;
                    }
                }
                listThree[i].checked = false;
            }

            if (score === 0) {
                alert(
                    "ohh..not good! your GK is bad!! :( " +
                    "\nYour Score: " +
                    score
                );
            } else if (score === 1 || score === 2) {
                alert(
                    "Not bad! your GK is decent!! :) " +
                    "\nYour Score: " +
                    score
                );
            } else if (score === 3) {
                alert(
                    "wow!! your GK is exceleent!! :) " +
                    "\nYour Score: " +
                    score
                );
            }
        ...
        const closeQuiz = () => {
            const quizSection = document.querySelector("#bg-section");
